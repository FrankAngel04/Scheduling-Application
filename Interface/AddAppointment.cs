    ...
    public partial class AddAppointment : Form
    {
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                appointmentRecordsForm.UpdateExceptionLabel("Appointment added successfully!", System.Drawing.Color.Green);
                Hide();
            }
            catch (Exception ex)
            {
        ...
        private void SaveAppointmentToDatabase(Dictionary<string, string> appointmentData)
        {
            try
            {
                ...
                using (var conn = DBConnection.conn)
                {
                    using (var transaction = conn.BeginTransaction())
                    {
                        ...
                        appointmentId = GetNewId(Queries.AppointmentIndex, conn).ToString();

                        cmd.CommandText = Queries.AddAppointment;
        ...
        private int GetNewId(string query, MySqlConnection conn)
        {
